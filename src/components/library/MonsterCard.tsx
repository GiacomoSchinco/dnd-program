...
type MonsterType = keyof typeof TYPE_META;
...
export function getMonsterTypeMeta(type: string | undefined): TypeMeta {
  const typeKey = type as MonsterType;
  return TYPE_META[typeKey] ?? { icon: User, color: 'text-base-content', label: type ?? '—' };
}
