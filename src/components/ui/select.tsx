  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-placeholder:text-amber-500",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-1.5 rounded-md py-2 pr-8 pl-2 text-sm outline-hidden select-none text-amber-900 hover:bg-amber-100 hover:text-amber-950 data-highlighted:bg-amber-100 data-highlighted:text-amber-950 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
